...
<?= Html::hiddenInput('factory', 'bam', ['id' => 'factory']); ?>
...
<div class="bam-form">
    ...
    <div class="col-md-6">
        ...
        <?= $form->field($model, 'b_date', ['template' => AppConstants::ACTIVE_FORM_TEMPLATE_INPUT_COL_FULL])
            ->widget(
        ...
        <?= $form->field($model, 'b_price', ['template' => AppConstants::ACTIVE_FORM_TEMPLATE_INPUT_COL_FULL])
        ...
        <?= $form->field($model, 'b_bruto', ['template' => AppConstants::ACTIVE_FORM_TEMPLATE_INPUT_COL_FULL])
            ->widget(NumberControl::className(),
                [
                    'model' => $model,
                    'displayOptions' => [
        ...
        <?= $form->field($model, 'b_tarra', ['template' => AppConstants::ACTIVE_FORM_TEMPLATE_INPUT_COL_FULL])
            ->widget(NumberControl::className(),
                [
                    'model' => $model,
                    'displayOptions' => [

...
<?= Html::hiddenInput('factory', 'ram', ['id' => 'factory']); ?>
...
<div class="ram-form">
    ...
    <div class="col-md-6">
        ...
        <?= $form->field($model, 'r_date', ['template' => AppConstants::ACTIVE_FORM_TEMPLATE_INPUT_COL_FULL])
            ->widget(
        ...
        <?= $form->field($model, 'r_price', ['template' => AppConstants::ACTIVE_FORM_TEMPLATE_INPUT_COL_FULL])
        ...
        <?= $form->field($model, 'r_bruto', ['template' => AppConstants::ACTIVE_FORM_TEMPLATE_INPUT_COL_FULL])
            ->widget(NumberControl::className(),
                [
                    'model' => $model,
                    'displayOptions' => [
        ...
        <?= $form->field($model, 'r_tarra', ['template' => AppConstants::ACTIVE_FORM_TEMPLATE_INPUT_COL_FULL])
            ->widget(NumberControl::className(),
                [
                    'model' => $model,
                    'displayOptions' => [
